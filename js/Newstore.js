var $w = jQuery.noConflict();
	...
	//Footer
	var d = new Date();
	var footer = '\n\r<div class="designer-wrapcens"><div id="designer-footer"><div id="designer-footernav"><div id="designer-footernav-title">Useful links</div><ul><li><a href="http://stores.ebay.com/marinerswarehousecom">Store Home</a></li><li><a href="http://stores.ebay.com/marinerswarehousecom">About Us</a></li><li><a href="http://stores.ebay.com/marinerswarehousecom">Shipping</a></li></ul><ul><li><a href="http://stores.ebay.com/marinerswarehousecom">Feedback</a></li><li><a href="http://stores.ebay.com/marinerswarehousecom">Payment</a></li><li><a href="http://stores.ebay.com/marinerswarehousecom">Returns</a></li></ul><ul><li><a href="http://stores.ebay.com/marinerswarehousecom">New Arrivals</a></li><li><a href="http://stores.ebay.com/marinerswarehousecom">Contact Us</a></li></ul></div><div id="designer-social"><div id="designer-footernav-title">Get in touch with us</div><p>We are trending on Social Media. Follow us and stay updated with our Latest News & Updates.</p><ul><li><a target="_blank" class="fb-icon" href="https://www.facebook.com/MarinersWarehouse"></a></li><li><a target="_blank" class="twit-https://twitter.com/account/suspended" href="#"></a></li><li><a target="_blank" class="gplus-icon" href="https://plus.google.com/+MarinersWarehouseMiami"></a></li><li><a target="_blank" class="mail-icon" href="skype:bidabing?chat"></a></li></ul></div><div id="designer-payment"><div id="designer-footernav-title">We Accept</div><div class="payment-logo"><img src="http://www.ebay-store-designer.com/estore/daxej/store/images/payment.png" alt="" /></div><div id="designer-footernav-title">We Accept</div><div class="payment-logo"><img src="http://www.ebay-store-designer.com/estore/daxej/store/images/payment.png" alt="" /><div class="#designer-footernav "><div class="#designer-footernav-title ">Facebook<div class="facebook-footer"><iframe src="https://www.facebook.com/plugins/likebox.php?href=http%3A%2F%2Fwww.facebook.com%2Fmarinerswarehouse&width=400&height=258&show_faces=true&colorscheme=light&stream=false&show_border=false&header=false" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:94%; height:414px; margin-bottom: 30px; background:#fff;" allowtransparency="true"></iframe></div><div id="designer-footernav-title">We Accept</div></div></div></div></div><div class="designer-clear"></div></div><div id="designer-footerwrapper"><div id="designer-footer"><div id="designer-copy">&copy; Copyright <span>marinerswarehousecom</span> ' + d.getFullYear() +'. All rights reserved.</div><div id="designer-designer">eBay Store Design & Developed By <a href="http://stores.ebay.com/marinerswarehousecom" target="_blank">M.Ali</a></div></div></div></div>';
